package com.poja.poja_big_sum_std21092.unit;
...
import com.poja.poja_big_sum_std21092.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "com.poja.poja_big_sum_std21092.endpoint.event.gen.UuidCreated", payload);
